...
class BottleneckAnalyzer:
    ...
    def get_critical_bottlenecks(self) -> List[Bottleneck]:
        ...
        return [bn for bn in self.bottlenecks if bn.severity == BottleneckSeverity.CRITICAL]

    def get_warnings(self) -> List[Bottleneck]:
        """Retorna apenas warnings."""
        return [bn for bn in self.bottlenecks if bn.severity == BottleneckSeverity.WARNING]
