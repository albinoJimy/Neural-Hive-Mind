...
def test_resilience_modules_import():
    ...
    try:
        from neural_hive_resilience.neural_hive_resilience.circuit_breaker import MonitoredCircuitBreaker
...
def test_feature_extraction_import():
    ...
    try:
        ...
        from neural_hive_specialists.feature_extraction.embeddings_generator import EmbeddingsGenerator
