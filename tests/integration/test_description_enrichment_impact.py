...
sys.path.insert(
    0, str(Path(__file__).parent.parent.parent / "services" / "specialist-technical" / "src")
)
...
class TestDescriptionEnrichmentImpact:
    ...
    def test_enriched_descriptions_have_higher_security_score(self):
        ...
        assert (
            enriched_security > generic_security
    ...
    def test_enriched_descriptions_have_higher_confidence(self):
        ...
        assert (
            enriched_confidence > generic_confidence
    ...
    def test_enriched_descriptions_have_more_words_per_task(self):
        ...
        assert (
            enriched_words > generic_words * 5
    ...
    def test_overall_improvement_summary(self):
        ...
        comparison = {
            ...
            "improvements": {
                "security_score": result_enriched["security_score"]
                - result_generic["security_score"],
                "performance_score": result_enriched["performance_score"]
                - result_generic["performance_score"],
                "code_quality_score": result_enriched["code_quality_score"]
                - result_generic["code_quality_score"],
                "architecture_score": result_enriched["architecture_score"]
                - result_generic["architecture_score"],
                "overall_score": result_enriched["overall_score"] - result_generic["overall_score"],
                "confidence_score": result_enriched["confidence_score"]
                - result_generic["confidence_score"],
                "mitigations_count": len(result_enriched["mitigations"])
                - len(result_generic["mitigations"]),
                "keywords_found": result_enriched["total_keywords_found"]
                - result_generic["total_keywords_found"],
            },
        }
        ...
        assert (
            comparison["improvements"]["overall_score"] >= 0.3
