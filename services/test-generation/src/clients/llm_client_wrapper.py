"""
Wrapper LLM Client para test-generation usando neural_hive_llm.
...
class LLMClient:
    """
    Cliente unificado para OpenAI usando neural_hive_llm.

    Wrapper que mantém a API existente do test-generation
