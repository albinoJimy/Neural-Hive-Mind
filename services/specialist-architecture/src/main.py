...
def main():
    """Função principal de inicialização do Architecture Specialist."""

    logger.info("Starting Architecture Specialist")

    # Carregar configuração
    try:
        config = ArchitectureSpecialistConfig()
        logger.info(
    ...
    # Criar especialista
    try:
        specialist = ArchitectureSpecialist(config)
        logger.info("Architecture Specialist initialized successfully")
    except Exception as e:
    ...
    def shutdown_handler(signum, frame):
        ...
        logger.info("Architecture Specialist shut down successfully")
        sys.exit(0)
    ...
    logger.info(
        "Architecture Specialist is ready",
