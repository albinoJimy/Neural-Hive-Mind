...
class TestCacheUnderStress:
    ...
    async def test_cache_large_entries(
        ...
        capability_patterns = [[f"cap-{i}", f"cap-{i+1}"] for i in range(100)]  # 100 padrões únicos
        ...
        assert cache_size <= 100, f"Cache deve ter <= 100 entradas, obtido: {cache_size}"
