...
from src.scheduler.preemption_rules import (
    PreemptionRules,
    PreemptionDecision
)
from src.scheduler.preemption import (
    PreemptionManager,
    PreemptionStatus
)
...
class TestPreemptionRules:
    ...
    def test_critical_can_preempt_normal(self, rules, high_priority_critical_ticket, normal_priority_ticket):
    ...
    def test_critical_can_preempt_low(self, rules, high_priority_critical_ticket, low_priority_ticket):
    ...
    def test_high_cannot_preempt_normal(self, rules, high_priority_high_ticket, normal_priority_ticket):
    ...
    def test_preemption_denied_execution_progress_too_high(
        self,
        rules,
        high_priority_critical_ticket,
        low_priority_ticket_far_in_progress
    ):
...
class TestPreemptionManager:
    ...
    def test_find_preemptible_ticket_returns_first_allowed(
        ...
        ticket = manager.find_preemptible_ticket(
