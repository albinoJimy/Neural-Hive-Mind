...
class TestGetCompensationAction:
    ...
    def test_validate_action_returns_revert_approval(self):
        ...
        params = {"approval_id": "approval-456", "validation_id": "val-789"}
    ...
    def test_execute_action_returns_rollback_execution(self):
        ...
        params = {"execution_id": "exec-101", "rollback_script": "cleanup.sh"}
...
class TestCompensateTicket:
    ...
    async def test_creates_compensation_ticket_with_correct_fields(self):
        ...
        ticket = {
            ...
            "priority": "HIGH",
            "status": "FAILED",
            "parameters": {"deployment_name": "my-deploy", "namespace": "production"},
        }
    ...
    async def test_records_metric_on_compensation(self):
        ...
        set_compensation_dependencies(
            config=MagicMock(), kafka_producer=mock_kafka, mongodb_client=None, metrics=mock_metrics
        )

        ticket = {"ticket_id": "ticket-123", "task_type": "BUILD", "parameters": {}}
    ...
    async def test_continues_without_kafka(self):
        ...
        set_compensation_dependencies(
            config=MagicMock(), kafka_producer=None, mongodb_client=None, metrics=None
        )

        ticket = {"ticket_id": "ticket-123", "task_type": "TEST", "parameters": {}}
...
class TestUpdateTicketCompensationStatus:
    ...
    async def test_updates_mongodb_with_compensation_reference(self):
        ...
        set_compensation_dependencies(
            config=MagicMock(), kafka_producer=None, mongodb_client=mock_mongodb, metrics=None
        )

        with patch("src.activities.compensation.activity"):
            result = await update_ticket_compensation_status(
                ticket_id="original-123", compensation_ticket_id="compensation-456"
            )
