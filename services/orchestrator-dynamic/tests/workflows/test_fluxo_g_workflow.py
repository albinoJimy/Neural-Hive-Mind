                ...
                with patch("src.workflows.fluxo_g_workflow.set_baggage"):
                    ...
                    with patch(
                        ...
                        mock_execute.side_effect = [
                            ...
                            make_result(
                                {"approved": True, "pass_rate": 1.0}
                            ),  # G7 quality validation
                            make_result(
                                {
                            ...
                            make_result(
                                {
                                    ...
                                    "workflow_id": "WF-001",
                                    "service_url": "http://service.nhm.local",
                                    "performance": {"response_time_ms": 150.0},
                                    "reliability": {"uptime_pct": 99.9},
                                    "quality": {"test_coverage": 0.85},
                                    "resource_usage": {"avg_cpu_pct": 35.0},
                ...
                with patch("src.workflows.fluxo_g_workflow.set_baggage"):
                    ...
                    with patch(
                        ...
                        mock_execute.side_effect = [
                            ...
                            make_result({"nodes_created": 5, "relations_created": 3}),  # G3
                            make_result(
                                {"query": "test", "response": "response", "context_used": True}
                            ),  # G5
                            make_result(
                                {
                                    "code_artifact_id": "CODE-001",
                            ...
                            make_result(
                                {
                                    ...
                                    "workflow_id": "WF-001",
                                    "service_url": "http://service.nhm.local",
                                    "performance": {"response_time_ms": 150.0, "error_rate": 0.001},
                                    "reliability": {"uptime_pct": 99.9},
                                    "quality": {"test_coverage": 0.85},
                                    "resource_usage": {"avg_cpu_pct": 35.0},
                                    "health_status": "healthy",
                            ...
                            make_result(
                                {
                                    ...
                                    "workflow_id": "WF-001",
                                    "service_url": "http://service.nhm.local",
                                    "performance": {"response_time_ms": 800.0, "error_rate": 0.1},
                                    "reliability": {"uptime_pct": 95.0},
                                    "quality": {"test_coverage": 0.5},
                                    "resource_usage": {"avg_cpu_pct": 90.0},
                            ...
                            make_result(
                                {
                                    ...
                                    "recommendations": ["Optimize performance", "Fix errors"],
                                }
                            ),  # G10
                            make_result(
                                {
                                    ...
                                    "trigger_reason": "very_low_quality_score",
                                }
                            ),  # G11
                            make_result(
                                {"priority": "high", "recommendations": ["Fix issues immediately"]}
                            ),  # G12
                            make_result(
                                {
                                    "status": "recorded",
