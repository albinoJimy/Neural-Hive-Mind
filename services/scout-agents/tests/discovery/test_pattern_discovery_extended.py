...
'''
    ...
    def test_analyze_pattern_frequency(self, pattern_discovery, sample_files):
        ...
        result = pattern_discovery.analyze_pattern_frequency(
            sample_files,
            'repository'
        )
    ...
    def test_calculate_pattern_confidence(self, pattern_discovery, sample_files):
        ...
        confidence = pattern_discovery.calculate_pattern_confidence(
            sample_files,
            'repository'
        )
...
'''
        ...
        static_method = next((m for m in structure['methods'] if m['name'] == 'static_method'), None)
