...
from ..models.template import Template, TemplateMetadata, TemplateRegistry, TemplateType
            ...
            try:
                ...
                try:
                    mcp_response = await asyncio.wait_for(
                        self.mcp_client.request_tool_selection(mcp_request), timeout=5.0
                    )
        ...
        try:
            ...
            for template_dir in templates_path.iterdir():
                ...
                if metadata_file.exists():
                    ...
                    template = self._create_template_from_directory(
                        template_dir, type_patterns, lang_extensions
                    )
