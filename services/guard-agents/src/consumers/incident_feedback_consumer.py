...
class IncidentFeedbackConsumer:
    ...
    def __init__(
        ...
        self.incident_stats = defaultdict(
            lambda: {
                "total": 0,
                "true_positives": 0,
                "false_positives": 0,
    ...
    async def _adjust_detection_thresholds(
        self, classification: str, direction: str, factor: float
    ) -> None:
        """
        ...
        try:
            ...
            logger.error(
                "falha_ajustar_thresholds_deteccao", classification=classification, error=str(e)
            )
    ...
    async def _reinforce_policies(self, classification: str) -> None:
        ...
        try:
            ...
            logger.info("politicas_reforcadas", classification=classification)
    ...
    def get_feedback_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "total_false_positives": sum(
                s["false_positives"] for s in self.incident_stats.values()
            ),
