...
class TestSemanticParserWithNLP:
    ...
    def mock_neo4j_client(self):
        ...
        mock.query_ontology = AsyncMock(
            return_value={"canonical_type": "resource", "properties": {}, "constraints": {}}
        )
    ...
    def intent_envelope_create(self):
        ...
        return {
            ...
            "intent": {
                ...
                "domain": "technical",
                "entities": [{"type": "service", "value": "REST API", "confidence": 0.9}],
            },
...
class TestNLPAccuracyComparison:
    ...
    async def test_nlp_keyword_extraction_quality(self, nlp_processor):
        ...
        test_text = (
            "Criar API REST para gerenciamento de produtos com autenticação JWT e cache Redis"
        )
        ...
        assert (
            found_technical >= 3
        ), f"Encontradas apenas {found_technical} palavras técnicas: {keywords}"
