...
class TestEntityDependencyBasics:
    ...
    def test_no_dependency_different_entities(self, dag_generator):
        ...
        intermediate_repr = {
            ...
            "entities": [{"type": "user", "name": "alice"}, {"type": "product", "name": "widget"}],
            "constraints": {},
        }
    ...
    def test_no_conflict_with_existing_dependency(self, dag_generator):
        ...
        for task in tasks:
            if task.metadata and task.metadata.get("conflicts_in_dag"):
                ...
                assert len(unresolved) == 0 or all(c.get("resolved") for c in conflicts)
...
class TestComplexScenarios:
    ...
    def test_nested_dependencies_no_cycles(self, dag_generator):
        ...
        intermediate_repr = {
            ...
            "entities": [{"type": "resource", "name": "data"}, {"type": "cache", "name": "temp"}],
...
class TestEdgeCases:
    ...
    def test_unicode_in_entity_names(self, dag_generator):
        ...
        intermediate_repr = {
            "objectives": ["create"],
            "entities": [{"type": "user", "name": "usuário"}, {"type": "product", "name": "商品"}],
            "constraints": {},
        }
