...
class TestDestructiveDetectorSeverityCalculation:
    ...
    def test_severity_medium_two_tasks(self, detector):
        ...
        tasks = [
            TaskNode(
                task_id="task-1", task_type="delete", description="Delete record 1", dependencies=[]
            ),
            TaskNode(
                task_id="task-2", task_type="delete", description="Delete record 2", dependencies=[]
            ),
        ]
        result = detector.detect(tasks)
    ...
    def test_severity_high_three_tasks(self, detector):
        ...
        tasks = [
            ...
            TaskNode(
                task_id="task-3", task_type="delete", description="Delete record 3", dependencies=[]
            ),
        ]
        result = detector.detect(tasks)
...
class TestDestructiveDetectorEdgeCases:
    ...
    def test_task_with_empty_description(self, detector):
        ...
        tasks = [TaskNode(task_id="task-1", task_type="query", description="", dependencies=[])]
        result = detector.detect(tasks)
    ...
    def test_task_with_empty_task_type(self, detector):
        ...
        tasks = [
            TaskNode(
                task_id="task-1", task_type="", description="Some description", dependencies=[]
            )
        ]
        result = detector.detect(tasks)
    ...
    def test_case_insensitive_detection(self, detector):
        ...
        tasks = [
            TaskNode(
                task_id="task-1", task_type="DELETE", description="Delete records", dependencies=[]
            ),
            TaskNode(
                task_id="task-2",
                task_type="Delete",
...
class TestDestructiveDetectorMetrics:
    ...
    def test_metrics_incremented_on_detection(self, mock_histogram, mock_counter, detector):
    ...
    @patch("src.services.destructive_detector.destructive_operations_detected_total")
    @patch("src.services.destructive_detector.destructive_tasks_per_plan")
    def test_histogram_observes_count(self, mock_histogram, mock_counter, detector):
    ...
    @patch("src.services.destructive_detector.destructive_operations_detected_total")
    @patch("src.services.destructive_detector.destructive_tasks_per_plan")
    def test_metrics_labels_correct(self, mock_histogram, mock_counter, detector):
        ...
        mock_counter.labels.assert_called_with(severity="low", detection_type="task_type_match")

    @patch("src.services.destructive_detector.destructive_operations_detected_total")
    @patch("src.services.destructive_detector.destructive_tasks_per_plan")
    def test_metrics_not_incremented_for_safe_operations(
        self, mock_histogram, mock_counter, detector
    ):
...
class TestDestructiveDetectorTaskTypeVariants:
    ...
    def test_detect_remove_task_type(self, detector):
        ...
        tasks = [
            TaskNode(
                task_id="task-1", task_type="remove", description="Remove item", dependencies=[]
            )
        ]
        result = detector.detect(tasks)
    ...
    def test_detect_purge_task_type(self, detector):
        ...
        tasks = [
            TaskNode(
                task_id="task-1", task_type="purge", description="Purge cache", dependencies=[]
            )
        ]
        result = detector.detect(tasks)
...
class TestDestructiveDetectorKeywordVariants:
    ...
    def test_detect_keyword_wipe(self, detector):
        ...
        tasks = [
            TaskNode(
                task_id="task-1", task_type="query", description="Wipe all data", dependencies=[]
            )
        ]
        result = detector.detect(tasks)
...
class TestDestructiveDetectorDisabled:
    ...
    @patch("src.services.destructive_detector.destructive_operations_detected_total")
    @patch("src.services.destructive_detector.destructive_tasks_per_plan")
    def test_disabled_no_metrics_recorded(self, mock_histogram, mock_counter, detector_disabled):
        """Com detector desabilitado, métricas não devem ser registradas"""
        tasks = [
            TaskNode(
                task_id="task-1", task_type="delete", description="Delete all data", dependencies=[]
            )
        ]
    ...
    def test_disabled_multiple_destructive_tasks(self, detector_disabled):
        ...
        tasks = [
            ...
            TaskNode(task_id="task-2", task_type="drop", description="Drop table", dependencies=[]),
            TaskNode(
                task_id="task-3",
                task_type="truncate",
...
class TestDestructiveDetectorStrictMode:
    ...
    def test_strict_mode_safe_task_without_indicators(self, detector_strict):
        ...
        tasks = [
            TaskNode(
                task_id="task-1", task_type="query", description="Get user by id", dependencies=[]
            )
        ]
        result = detector_strict.detect(tasks)
