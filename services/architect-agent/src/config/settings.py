...
class KafkaConfig(BaseModel):
    ...
    cognitive_plans_topic: str = Field(default="cognitive.plans.created", description="Cognitive plans topic")
...
class MongoDBConfig(BaseModel):
    ...
    collection_architecture: str = Field(default="architecture_plans", description="Architecture plans collection")
    collection_validation: str = Field(default="validation_reports", description="Validation reports collection")
    collection_evolution: str = Field(default="evolution_history", description="Evolution history collection")
...
class ObservabilityConfig(BaseModel):
    ...
    otel_endpoint: str = Field(default="http://otel-collector:4317", description="OpenTelemetry endpoint")
