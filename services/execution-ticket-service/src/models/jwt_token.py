...
def generate_token(
    ...
    scopes = ["ticket:read", "ticket:update", f"task:{task_type_str.lower()}"]
    ...
    # Gerar JWT
    encoded_jwt = pyjwt.encode(payload.model_dump(), secret_key, algorithm=algorithm)
...
def decode_token(token: str, secret_key: str, algorithm: str = "HS256") -> JWTTokenPayload:
    """
...
def validate_token(token: str, ticket_id: str, secret_key: str, algorithm: str = "HS256") -> bool:
    """
