...
class CircuitBreaker:
    ...
    def reset(self) -> None:
        ...
        if previous_state != "CLOSED":
            logger.info("redis_circuit_breaker_reset", previous_state=previous_state)
...
async def get_redis_client(settings) -> Optional[redis.Redis]:
    """
    ...
    try:
        ...
        redis_ssl = getattr(settings, "redis_ssl_enabled", False)
