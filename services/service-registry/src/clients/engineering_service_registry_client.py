...
class EngineeringServiceRegistryClient:
    ...
    def __init__(self, service_name: str, agent_type: service_registry_pb2.AgentType):
        """
        Inicializa o cliente.

        Args:
            service_name: Nome do serviço (ex: "requirements-engineering")
...
async def register_engineering_service(
    service_name: str,
    agent_type: service_registry_pb2.AgentType,
    capabilities: list[str],
    metadata: Optional[dict[str, str]] = None,
) -> Optional[EngineeringServiceRegistryClient]:
    """
