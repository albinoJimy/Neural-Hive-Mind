...
class ServiceRegistryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.NotifyAgent = channel.unary_unary(
                ...
                request_serializer=src_dot_proto_dot_service__registry__pb2.NotifyAgentRequest.SerializeToString,
                response_deserializer=src_dot_proto_dot_service__registry__pb2.NotifyAgentResponse.FromString,
                _registered_method=True)
...
def add_ServiceRegistryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'NotifyAgent': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=src_dot_proto_dot_service__registry__pb2.NotifyAgentRequest.FromString,
                    response_serializer=src_dot_proto_dot_service__registry__pb2.NotifyAgentResponse.SerializeToString,
            ),
    }
...
class ServiceRegistry(object):
    ...
    def NotifyAgent(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/neural_hive.service_registry.ServiceRegistry/NotifyAgent',
            src_dot_proto_dot_service__registry__pb2.NotifyAgentRequest.SerializeToString,
            src_dot_proto_dot_service__registry__pb2.NotifyAgentResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
