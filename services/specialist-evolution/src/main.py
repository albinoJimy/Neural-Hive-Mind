"""
Ponto de entrada do Evolution Specialist.
"""
import logging
import asyncio
...
def main():
    """Função principal de inicialização do Evolution Specialist."""

    logger.info("Starting Evolution Specialist")
    ...
    # Criar especialista
    try:
        specialist = EvolutionSpecialist(config)
        logger.info("Evolution Specialist initialized successfully")
    except Exception as e:
    ...
    def shutdown_handler(signum, frame):
        ...
        logger.info("Evolution Specialist shut down successfully")
        sys.exit(0)
