...
class StrategicDecisionResponse(_message.Message):
    ...
    def __init__(
        self,
        decision_id: _Optional[str] = ...,
        decision_type: _Optional[str] = ...,
        confidence_score: _Optional[float] = ...,
        risk_score: _Optional[float] = ...,
        reasoning_summary: _Optional[str] = ...,
        created_at: _Optional[int] = ...,
        target_entities: _Optional[_Iterable[str]] = ...,
...
class ListStrategicDecisionsResponse(_message.Message):
    ...
    def __init__(
        self,
        decisions: _Optional[
            _Iterable[_Union[StrategicDecisionResponse, _Mapping]]
        ] = ...,
        total: _Optional[int] = ...,
    ) -> None: ...
...
class SystemStatusResponse(_message.Message):
    ...
    def __init__(
        self,
        system_score: _Optional[float] = ...,
        sla_compliance: _Optional[float] = ...,
        error_rate: _Optional[float] = ...,
        resource_saturation: _Optional[float] = ...,
        active_incidents: _Optional[int] = ...,
...
class RequestExceptionRequest(_message.Message):
    ...
    def __init__(
        ...
        guardrails_affected: _Optional[_Iterable[str]] = ...,
...
class RequestExceptionResponse(_message.Message):
    ...
    status: str
    def __init__(
        self, exception_id: _Optional[str] = ..., status: _Optional[str] = ...
    ) -> None: ...
...
class RejectExceptionRequest(_message.Message):
    ...
    reason: str
    def __init__(
        self, exception_id: _Optional[str] = ..., reason: _Optional[str] = ...
    ) -> None: ...
...
class GetActiveConflictsResponse(_message.Message):
    ...
    def __init__(
        self, conflicts: _Optional[_Iterable[_Union[ConflictInfo, _Mapping]]] = ...
    ) -> None: ...
...
class Recommendation(_message.Message):
    ...
    def __init__(
        ...
        estimated_impact: _Optional[float] = ...,
    ) -> None: ...
...
class SubmitInsightRequest(_message.Message):
    ...
    def __init__(
        self,
        insight_id: _Optional[str] = ...,
        version: _Optional[str] = ...,
        correlation_id: _Optional[str] = ...,
        trace_id: _Optional[str] = ...,
        span_id: _Optional[str] = ...,
        insight_type: _Optional[str] = ...,
        priority: _Optional[str] = ...,
        title: _Optional[str] = ...,
        summary: _Optional[str] = ...,
        detailed_analysis: _Optional[str] = ...,
        data_sources: _Optional[_Iterable[str]] = ...,
        metrics: _Optional[_Mapping[str, float]] = ...,
        confidence_score: _Optional[float] = ...,
        impact_score: _Optional[float] = ...,
        recommendations: _Optional[_Iterable[_Union[Recommendation, _Mapping]]] = ...,
        related_entities: _Optional[_Iterable[_Union[RelatedEntity, _Mapping]]] = ...,
        time_window: _Optional[_Union[TimeWindow, _Mapping]] = ...,
        created_at: _Optional[int] = ...,
        valid_until: _Optional[int] = ...,
