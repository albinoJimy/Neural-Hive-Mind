"""
Wrapper LLM Client para approval-gateway usando neural_hive_llm.
...
class LLMClient:
    ...
    Wrapper que mantém a API existente do approval-gateway
    ...
    def _get_fallback_text(self, messages: list[dict[str, str]]) -> str:
        ...
        return "AVALIACAO: 50\nRACIOCINIO: Serviço temporariamente indisponível."
