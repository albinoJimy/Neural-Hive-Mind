...
# Import proto do service-registry (deve estar instalado como pacote)
try:
    from service_registry_pb2 import AgentType
    from service_registry_pb2_grpc import ServiceRegistryStub
except ImportError:
    # Fallback para import local se não estiver instalado
    import sys
    ...
    try:
        ...
        # Se ainda falhar, definir placeholder
        AgentType = None
        ServiceRegistryStub = None
...
class EngineeringServiceRegistryClient:
    ...
    def __init__(self, service_name: str, agent_type):
        ...
        Args:
            service_name: Nome do serviço (ex: "knowledge-graph-rag")
