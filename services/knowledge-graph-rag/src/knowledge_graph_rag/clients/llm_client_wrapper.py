"""Wrapper LLM Client para knowledge-graph-rag usando neural_hive_llm.
...
class LLMClient:
    ...
    Wrapper que mantém a API existente do knowledge-graph-rag
    ...
    def _get_fallback_text(self, messages: list[dict[str, str]]) -> str:
        ...
        return "Knowledge Graph RAG response placeholder."
