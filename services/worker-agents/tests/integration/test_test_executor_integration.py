...
class TestTestExecutorTimeout:
    ...
    async def test_test_executor_github_timeout(
        ...
        from clients.github_actions_client import GitHubActionsTimeoutError
    ...
    async def test_test_executor_gitlab_timeout(
        ...
        from clients.gitlab_ci_client import GitLabCITimeoutError
    ...
    async def test_test_executor_jenkins_timeout(
        ...
        from clients.jenkins_client import JenkinsTimeoutError

        mock_jenkins_client.wait_for_build.side_effect = JenkinsTimeoutError("Build timed out")
...
<testsuite name="test_suite" tests="5" failures="2" errors="0" skipped="0">
    ...
    <testcase classname="test.Test2" name="test_fail_2" time="0.2">
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                result = test_executor_local_only._parse_junit_xml_file("junit.xml", tmpdir)
...
<coverage line-rate="0.75" branch-rate="0.5" lines-covered="75" lines-valid="100">
    <packages>
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                result = test_executor_local_only._parse_coverage_file("coverage.xml", tmpdir)
...
class TestTestExecutorSimulation:
    ...
    async def test_test_executor_simulation_fallback(self, worker_config, mock_metrics):
        ...
        ticket_id = str(uuid.uuid4())
        ticket = {"ticket_id": ticket_id, "task_type": "TEST", "parameters": {"test_suite": "unit"}}
