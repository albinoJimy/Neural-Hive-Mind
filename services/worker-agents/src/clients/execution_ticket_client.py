...
class ExecutionTicketClient:
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.logger.exception("execution_ticket_client_init_failed", error=str(e))
            raise
    ...
    async def get_ticket(self, ticket_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.exception("get_ticket_failed", ticket_id=ticket_id, error=str(e))
            raise
        finally:
            if self.metrics:
    ...
    async def update_ticket_status(
        ...
        try:
            ...
            if self.metrics:
                self.metrics.ticket_api_calls_total.labels(
                    method="update_ticket_status", status=api_status
                ).inc()
    ...
    async def get_ticket_token(self, ticket_id: str) -> str:
        ...
        try:
            ...
            self.logger.exception("get_ticket_token_failed", ticket_id=ticket_id, error=str(e))
            raise
    ...
    async def list_tickets(
        ...
        try:
            ...
            self.logger.exception("list_tickets_failed", error=str(e))
            raise
