...
class KafkaProducerClient:
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            self.logger.info(
                "kafka_producer_started", bootstrap_servers=self.settings.bootstrap_servers
            )
    ...
    async def publish_budget_update(self, budget: ErrorBudget) -> None:
        ...
        try:
            ...
            self.logger.error("budget_event_publish_failed", slo_id=budget.slo_id, error=str(e))
    ...
    async def publish_freeze_event(self, event: FreezeEvent, action: str) -> None:
        ...
        try:
            ...
            self.logger.error("freeze_event_publish_failed", event_id=event.event_id, error=str(e))
    ...
    async def publish_slo_violation(
        ...
        try:
            ...
            self.logger.info(
                "violation_event_published", slo_id=slo_id, service=service_name, topic=topic
            )
        except Exception as e:
            self.logger.error("violation_event_publish_failed", slo_id=slo_id, error=str(e))
