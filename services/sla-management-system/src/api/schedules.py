...
from src.models.schedule import (
    ...
    SchedulePriority, ScheduleCreateRequest, ScheduleTriggerResponse
)
...
def get_schedule_manager() -> ScheduleManager:
    ...
    if _schedule_manager is None:
        raise HTTPException(
            status_code=503,
            detail="ScheduleManager not initialized"
        )
...
async def list_schedule_executions(
    ...
    TODO: Implementar após criar tabela schedule_executions.
    """
