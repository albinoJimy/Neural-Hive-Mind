...
class DecisionProducer:
    ...
    async def initialize(self):
        ...
        if schema_registry_url and schema_registry_url.strip():
            ...
            if os.path.exists(schema_path):
                ...
                logger.info(
                    "Schema Registry configurado para producer",
        ...
        logger.info("Decision producer inicializado", topic=self.config.kafka_consensus_topic)
            ...
            while self.running:
                try:
                    ...
                    await asyncio.get_event_loop().run_in_executor(
                        None, lambda: self.producer.flush(timeout=0.1)
                    )
                    continue
    ...
    async def _publish_decision(self, decision: ConsolidatedDecision):
        ...
        try:
            ...
            await asyncio.get_event_loop().run_in_executor(None, lambda: self.producer.poll(0))
