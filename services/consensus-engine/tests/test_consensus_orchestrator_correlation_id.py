...
class TestConsensusOrchestratorCorrelationId:
    ...
    async def test_multiple_calls_generate_unique_fallback_ids(
        self, mock_consensus_orchestrator_config, mock_pheromone_client, sample_specialist_opinions
    ):
        ...
        for _ in range(3):
            ...
            decision = await orchestrator.process_consensus(
                cognitive_plan=plan, specialist_opinions=sample_specialist_opinions
            )
