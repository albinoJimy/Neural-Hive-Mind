...
class HealthChecksPhase(InitializationPhase):
    ...
    async def execute(self, context: ApplicationContext) -> bool:
        try:
            ...
            try:
                ...
                from neural_hive_observability.health import RedisHealthCheck, CustomHealthCheck
                ...
                # Registrar checks
                self._register_checks(context, RedisHealthCheck, CustomHealthCheck, OTELPipelineHealthCheck)
    ...
    def _register_checks(self, context, RedisHealthCheck, CustomHealthCheck, OTELPipelineHealthCheck):
