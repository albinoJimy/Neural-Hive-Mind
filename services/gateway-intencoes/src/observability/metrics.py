...
# Métricas de sistema
active_connections = Gauge("gateway_active_connections", "Conexões ativas no gateway")
...
nlu_cache_operations_total = Counter(
    ...
    [
        "operation",
        "status",
    ],  # operation: get/set/delete, status: hit/miss/error/corruption
)
