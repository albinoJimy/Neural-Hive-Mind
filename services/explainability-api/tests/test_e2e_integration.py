...
class TestE2EConsensusToExplanation:
    ...
    def consensus_decision(self):
        ...
        return {
            ...
            "consensus_process": {
                ...
                "num_specialists": 5,
                "aggregation": {"confidence": 0.875, "risk": 0.125, "divergence": 0.10},
    ...
    async def test_full_flow_hierarchical_fields_present(self, consensus_decision, mock_services):
        ...
        mock_services["shap_calculator"].calculate_shap.return_value = {
            "feature_attribution": {"confidence": 0.50, "risk": -0.15, "seniority_multiplier": 0.10}
        }
    ...
    async def test_explanation_shap_values_calculated(self, consensus_decision, mock_services):
        ...
        mock_services["quality_scorer"].score_explanation.return_value = {"overall": 0.85}
    ...
    async def test_explanation_quality_scores_calculated(self, consensus_decision, mock_services):
        ...
        api = ExplainabilityAPIExtensions(
            mongodb_client=MagicMock(), quality_scorer=mock_services["quality_scorer"]
        )
