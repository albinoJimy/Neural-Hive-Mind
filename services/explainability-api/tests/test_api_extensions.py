...
class TestPostGenerateExplanation:
    ...
    @pytest.mark.asyncio
    async def test_generate_creates_new_explanation(
        self,
        mock_services,
    ...
    @pytest.mark.asyncio
    async def test_generate_with_text_format(
        self,
        mock_services,
        sample_generation_request
    ):
    ...
    @pytest.mark.asyncio
    async def test_generate_with_html_format(
        self,
        mock_services,
        sample_generation_request
    ):
...
class TestShapIntegration:
    ...
    async def test_shap_calculator_called_on_generate(self, mock_shap_calculator):
        ...
        api = ExplainabilityAPIExtensions(
            mongodb_client=MagicMock(),
            shap_calculator=mock_shap_calculator
        )
