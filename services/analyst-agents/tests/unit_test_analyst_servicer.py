...
def mock_mongodb_client():
    ...
    client.get_insight_statistics = AsyncMock(
        return_value={
            "by_type": {},
            "by_priority": {},
            "avg_confidence": 0.0,
...
def mock_analytics_engine():
    ...
    engine.calculate_trend = MagicMock(
        return_value={"slope": 0.5, "direction": "up", "confidence": 0.8}
    )
...
class TestQueryInsights:
    ...
    async def test_query_insights_with_time_filter(
        ...
        request = analyst_agent_pb2.QueryInsightsRequest(
            start_timestamp=1704067200000, end_timestamp=1704153600000, limit=10
        )
...
class TestExecuteAnalysis:
    ...
    async def test_execute_missing_metric_name(self, servicer, mock_grpc_context):
        ...
        request = analyst_agent_pb2.ExecuteAnalysisRequest(
            analysis_type="anomaly_detection", parameters={}
        )
...
class TestGetStatistics:
    ...
    async def test_get_statistics_with_time_filter(
        ...
        request = analyst_agent_pb2.GetStatisticsRequest(
            start_timestamp=1704067200000, end_timestamp=1704153600000
        )
...
class TestInsightConversion:
    ...
    def test_insight_dict_to_proto_missing_fields(self, servicer):
        ...
        insight_dict = {"insight_id": "test-id"}
