...
class EmbeddingService:
    ...
    async def generate_embedding(self, text: str, use_cache: bool = True) -> Optional[np.ndarray]:
        ...
        try:
            ...
            # Salvar no cache
            if use_cache and self.cache_client:
                await self.cache_client.set(cache_key, embedding.tobytes(), ttl=3600)  # 1 hora
            ...
            if uncached_texts:
                ...
                for i, embedding in zip(uncached_indices, new_embeddings):
                    ...
                    if use_cache and self.cache_client:
                        ...
                        await self.cache_client.set(cache_key, embedding.tobytes(), ttl=3600)
        ...
        try:
            ...
            for i, label in enumerate(labels):
                ...
                if label_key not in clusters:
                    clusters[label_key] = []
                clusters[label_key].append({"text": texts[i], "index": i})
