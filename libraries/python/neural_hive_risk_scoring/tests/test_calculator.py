...
class TestRiskCalculator:
    ...
    def test_calculate_aggregate_risk(self, calculator, sample_assessments):
        ...
        matrix = calculator.calculate_aggregate_risk(
            assessments=sample_assessments, entity_id="test-entity", entity_type="plan"
        )
    ...
    def test_empty_assessments(self, calculator):
        ...
        matrix = calculator.calculate_aggregate_risk(
            assessments=[], entity_id="empty-entity", entity_type="plan"
        )
    ...
    def test_weighted_average_aggregation(self, config):
        ...
        calculator = RiskCalculator(
            config=config, aggregation_strategy=AggregationStrategy.WEIGHTED_AVERAGE
        )
        ...
        matrix = calculator.calculate_aggregate_risk(
            assessments=assessments, entity_id="test", entity_type="plan"
        )
    ...
    def test_maximum_aggregation(self, config):
        ...
        calculator = RiskCalculator(config=config, aggregation_strategy=AggregationStrategy.MAXIMUM)
    ...
    def test_calculate_domain_contribution(self, calculator, sample_assessments):
        ...
        matrix = calculator.calculate_aggregate_risk(
            assessments=sample_assessments, entity_id="test", entity_type="plan"
        )
    ...
    def test_geometric_mean_aggregation(self, config):
        ...
        calculator = RiskCalculator(
            config=config, aggregation_strategy=AggregationStrategy.GEOMETRIC_MEAN
        )
    ...
    def test_harmonic_mean_aggregation(self, config):
        ...
        calculator = RiskCalculator(
            config=config, aggregation_strategy=AggregationStrategy.HARMONIC_MEAN
        )
    ...
    def test_minimum_aggregation(self, config):
        ...
        calculator = RiskCalculator(config=config, aggregation_strategy=AggregationStrategy.MINIMUM)
    ...
    def test_custom_domain_weights(self, config):
        ...
        calculator = RiskCalculator(config=config, domain_weights=custom_weights)
    ...
    def test_entity_types(self, calculator, sample_assessments):
        ...
        for entity_type in entity_types:
            matrix = calculator.calculate_aggregate_risk(
                assessments=sample_assessments, entity_id="test", entity_type=entity_type
            )
    ...
    def test_single_assessment(self, calculator):
        ...
        matrix = calculator.calculate_aggregate_risk(
            assessments=single_assessment, entity_id="test", entity_type="plan"
        )
