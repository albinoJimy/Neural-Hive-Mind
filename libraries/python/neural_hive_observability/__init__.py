...
from .tracing import init_tracing, trace_intent, trace_plan, get_tracer
...
metrics = property(lambda: get_metrics())
health = property(lambda: get_health_checker())
context = property(lambda: get_context_manager())
