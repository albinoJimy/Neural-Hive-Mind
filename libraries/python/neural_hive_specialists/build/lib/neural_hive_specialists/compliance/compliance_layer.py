...
class ComplianceLayer:
    ...
    def __init__(self, config, specialist_type: str, metrics):
        ...
        try:
            ...
            self.field_encryptor = FieldEncryptor(config) if config.enable_field_encryption else None
            self.audit_logger = AuditLogger(config, specialist_type) if config.enable_audit_logging else None
    ...
    def encrypt_opinion_fields(
        self,
        opinion_doc: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
