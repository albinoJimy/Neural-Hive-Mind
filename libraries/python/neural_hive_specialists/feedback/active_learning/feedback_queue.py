...
class PriorityFeedbackQueue:
    ...
    def __init__(
        ...
        logger.info(
            'PriorityFeedbackQueue initialized',
    ...
    def enqueue_plan_for_review(
        ...
        priority_reason = self._generate_priority_reason(
            information_value, prediction
        )
    ...
    def claim_case(
        ...
        result = self.collection.update_one(
            {'queue_id': queue_id, 'status': QueueStatus.PENDING},
            update
        )
