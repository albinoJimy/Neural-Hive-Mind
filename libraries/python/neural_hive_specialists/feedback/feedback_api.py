...
def verify_jwt_token(
    ...
    if not config.feedback_require_authentication:
        ...
        return {"sub": "anonymous", "role": "human_expert"}
...
def create_feedback_router(
    ...
    async def submit_feedback(
        request: SubmitFeedbackRequest, authorization: Optional[str] = Header(None)
    ):
        """
            ...
            if pii_detector and pii_detector.enabled and feedback_notes:
                try:
                    anonymized_notes, pii_entities = pii_detector.anonymize_text(
                        text=feedback_notes, language="pt"  # Pode ser parametrizado
                    )
    ...
    async def get_feedback_by_opinion(
        ...
        try:
            ...
            verify_jwt_token(
                ...
                config,
                audit_logger,
                f"/api/v1/feedback/opinion/{opinion_id}",
            )
    ...
    async def trigger_online_update(
        ...
        try:
            ...
            payload = verify_jwt_token(
                ...
                config,
                audit_logger,
                "/api/v1/feedback/trigger-online-update",
            )
        ...
        try:
            ...
            try:
                ...
                count = feedback_collector.count_recent_feedback(
                    specialist_type=config.specialist_type, window_days=1
                )
