...
class TestS3StorageClient:
    ...
    def mock_boto3_client(self):
        ...
        with patch('neural_hive_specialists.disaster_recovery.storage_client.boto3') as mock_boto3:
            mock_client = Mock()
    ...
    def test_s3_delete_backup_success(self, s3_client, mock_boto3_client):
        ...
        mock_boto3_client.delete_object.assert_called_once_with(
            Bucket='test-bucket',
            Key='backups/test-backup.tar.gz'
        )
...
class TestGCSStorageClient:
    ...
    def mock_gcs_client(self):
        ...
        with patch('neural_hive_specialists.disaster_recovery.storage_client.storage') as mock_storage:
            mock_client = Mock()
            mock_bucket = Mock()
