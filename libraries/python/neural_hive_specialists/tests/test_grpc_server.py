...
class TestHealthCheck:
    ...
    def test_health_check_serving(self, servicer):
        ...
        servicer.specialist.health_check = Mock(
            return_value={
                "status": "SERVING",
    ...
    def test_health_check_not_serving(self, servicer):
        ...
        servicer.specialist.health_check = Mock(
            return_value={"status": "NOT_SERVING", "details": {"model_loaded": "False"}}
        )
...
class TestSpecialistServicerComplete:
    ...
    def mock_specialist_complete(self):
        ...
        specialist.evaluate_plan.return_value = {
            ...
            "opinion": {
                ...
                "metadata": {"domain": "software_development", "num_tasks": 5},
            },
        }
        ...
        specialist.get_capabilities.return_value = {
            ...
            "configuration": {"enable_caching": "true", "max_batch_size": "10"},
        }
    ...
    def test_evaluate_plan_success_full_response(
        ...
        with patch("neural_hive_specialists.grpc_server.PROTO_AVAILABLE", True):
            with patch(
                ...
                mock_pb2.EvaluatePlanResponse.return_value = Mock(
                    opinion_id="test-opinion-123", specialist_type="test"
                )
    ...
    def test_evaluate_plan_grpc_error_invalid_argument(
        self, servicer_complete, mock_specialist_complete
    ):
    ...
    def test_get_capabilities_with_valid_iso8601_timestamp(
        self, servicer_complete, mock_specialist_complete
    ):
