...
class TestDatasetBalanceAnalyzer:
    ...
    def test_calculate_balance_metrics_returns_metrics(
        self,
        analyzer,
        mock_collection
    ):
    ...
    def test_balance_metrics_calculates_class_distribution(
        self,
        analyzer,
        mock_collection
    ):
    ...
    def test_confidence_distribution_calculates_correctly(
        self,
        analyzer,
        mock_collection
    ):
    ...
    def test_domain_distribution_identifies_domains(
        self,
        analyzer,
        mock_collection
    ):
        ...
        assert metrics.domain_distribution['technical']['percentage'] == pytest.approx(50.0, rel=0.1)
        assert metrics.domain_distribution['security']['count'] == 1

    def test_semantic_features_count_identifies_enriched_feedbacks(
        self,
        analyzer,
        mock_collection
    ):
    ...
    def test_priority_recommendations_includes_confidence_gaps(
        self,
        analyzer,
        mock_collection
    ):
    ...
    def test_calculate_balance_metrics_handles_empty_collection(
        self,
        analyzer,
        mock_collection
    ):
    ...
    def test_calculate_balance_metrics_handles_missing_fields(
        self,
        analyzer,
        mock_collection
    ):
        ...
        mock_collection.aggregate.return_value = [
            ...
            {'human_recommendation': 'reject', 'opinion_confidence': 0.3, 'nlp_features': {'primary_domain': 'test'}},
...
class TestPriorityRecommendation:
    ...
    def test_priority_recommendation_creation(self):
        ...
        rec = PriorityRecommendation(
            ...
            value='reject',
            gap=40.0,
            reason='Sub-representado no dataset'
        )
