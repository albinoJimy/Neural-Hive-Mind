...
def mock_config():
    ...
    config.pii_entities_to_detect = ['PERSON', 'EMAIL_ADDRESS', 'PHONE_NUMBER', 'LOCATION']
...
class TestPIIDetectorInitialization:
    ...
    def test_initialization_handles_spacy_model_error(self, mock_config):
        ...
        with patch('presidio_analyzer.nlp_engine.NlpEngineProvider') as mock_nlp_provider:
            mock_nlp_provider.return_value.create_engine.side_effect = Exception("spaCy model not found")
...
class TestAnonymizeText:
    ...
    def test_anonymize_text_success(self, detector, mock_analyzer_result, mock_anonymized_result):
        ...
        anonymized_text, metadata = detector.anonymize_text("João Silva mora em São Paulo", language='pt')
    ...
    def test_anonymize_text_metadata_shape(self, detector, mock_analyzer_result, mock_anonymized_result):
    ...
    def test_anonymize_text_unsupported_language_fallback(self, detector, mock_analyzer_result, mock_anonymized_result):
...
class TestAnonymizeDict:
    ...
    def test_anonymize_dict_simple_field(self, detector, mock_analyzer_result, mock_anonymized_result):
    ...
    def test_anonymize_dict_nested_field(self, detector, mock_analyzer_result, mock_anonymized_result):
