...
class TestCorrelateOpinionsWithDecisions:
    ...
    def test_all_agree_tp(self, collector):
        ...
        decisions = [{
            ...
            'specialist_votes': [
                {'opinion_id': 'op1', 'recommendation': 'approve', 'specialist_type': 'technical'},
                {'opinion_id': 'op2', 'recommendation': 'approve', 'specialist_type': 'business'}
            ],
            'plan_id': 'plan1'
        }]
    ...
    def test_all_agree_tn(self, collector):
        ...
        decisions = [{
            ...
            'specialist_votes': [
                {'opinion_id': 'op1', 'recommendation': 'reject', 'specialist_type': 'technical'},
                {'opinion_id': 'op2', 'recommendation': 'reject', 'specialist_type': 'business'}
            ],
            'plan_id': 'plan1'
        }]
    ...
    def test_ignore_review_required(self, collector):
        ...
        decisions = [{
            'final_decision': 'APPROVE',
            'specialist_votes': [
                {'opinion_id': 'op1', 'recommendation': 'review_required', 'specialist_type': 'technical'},
                {'opinion_id': 'op2', 'recommendation': 'conditional', 'specialist_type': 'business'}
            ],
            'plan_id': 'plan1'
        }]
        ...
        decisions = [
            {
                'final_decision': 'APPROVE',
                'specialist_votes': [
                    {'opinion_id': 'op1', 'recommendation': 'approve', 'specialist_type': 'technical'},  # TP
                    {'opinion_id': 'op2', 'recommendation': 'reject', 'specialist_type': 'business'}     # FN
                ],
                'plan_id': 'plan1'
            },
            {
                'final_decision': 'REJECT',
                'specialist_votes': [
                    {'opinion_id': 'op3', 'recommendation': 'reject', 'specialist_type': 'behavior'},    # TN
                    {'opinion_id': 'op4', 'recommendation': 'approve', 'specialist_type': 'technical'}   # FP
                ],
                'plan_id': 'plan2'
            }
        ]
...
class TestCollectBusinessMetrics:
    ...
    def test_no_data(self, collector):
        ...
        with patch.object(collector, 'ledger_collection') as mock_ledger, \
             patch.object(collector, 'consensus_collection') as mock_consensus:
    ...
    def test_successful_collection(self, mock_post, collector, mock_metrics_registry):
        ...
        # Mock de opiniões
        opinions = [
            {'opinion_id': 'op1', 'evaluated_at': datetime.utcnow(), 'specialist_type': 'technical'},
            {'opinion_id': 'op2', 'evaluated_at': datetime.utcnow(), 'specialist_type': 'business'},
            {'opinion_id': 'op3', 'evaluated_at': datetime.utcnow(), 'specialist_type': 'technical'}
        ]
        ...
        decisions = [
            ...
            },
            {
                ...
                'final_decision': 'REJECT',
                'specialist_votes': [
                    {'opinion_id': 'op3', 'recommendation': 'reject', 'specialist_type': 'technical'}    # TN
                ],
                'plan_id': 'plan2'
            }
        ]
