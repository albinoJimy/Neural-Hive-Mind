...
class TestBatchEvaluator:
    ...
    def mock_specialist(self):
        ...
        specialist.feature_extractor.extract_features = Mock(
            return_value={
        ...
        specialist._parse_model_prediction = Mock(
            return_value={
        ...
        specialist._evaluate_plan_internal = Mock(
            side_effect=lambda plan, ctx: {
