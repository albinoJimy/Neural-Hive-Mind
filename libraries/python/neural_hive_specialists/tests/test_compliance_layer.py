        ...
        "tasks": [
            {
                ...
                "parameters": {"email": "joao@example.com", "phone": "11-99999-9999"},
            },
            {"description": "Processar dados do cliente", "parameters": {}},
        ],
        "metadata": {"owner": "Maria Santos", "department": "Vendas"},
    }
...
def sample_opinion_doc():
    ...
    return {
        ...
        "trace_id": "trace-789",
        "opinion": {"verdict": "approved", "reasoning": "Analysis complete"},
    }
...
class TestComplianceLayerInitialization:
    ...
    def test_initialization_all_components_enabled(
        self, mock_audit, mock_encryptor, mock_pii, mock_config, mock_metrics
    ):
    ...
    @patch("neural_hive_specialists.compliance.compliance_layer.PIIDetector")
    @patch("neural_hive_specialists.compliance.compliance_layer.FieldEncryptor")
    def test_initialization_partial_components(
        self, mock_encryptor, mock_pii, mock_config, mock_metrics
    ):
...
class TestEncryptOpinionFields:
    ...
    def test_encrypt_opinion_fields_success(self, compliance, sample_opinion_doc):
        ...
        compliance.field_encryptor.encrypt_dict.assert_called_once_with(
            sample_opinion_doc, compliance.config.fields_to_encrypt
        )
...
class TestDecryptOpinionFields:
    ...
    def test_decrypt_fallback_to_config_fields(self, compliance):
        ...
        encrypted_doc = {"opinion_id": "opinion-123", "correlation_id": "enc:encrypted"}
        compliance.field_encryptor.decrypt_dict = Mock(return_value=encrypted_doc)
