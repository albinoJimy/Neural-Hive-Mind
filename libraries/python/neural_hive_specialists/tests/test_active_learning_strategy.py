...
class TestActiveLearningStrategy:
    ...
    def test_calculate_information_value_weights(self, strategy_custom_weights):
        ...
        value_low_conf = strategy_custom_weights.calculate_information_value(
            case_low_conf
        )
        value_high_conf = strategy_custom_weights.calculate_information_value(
            case_high_conf
        )
...
class TestInformationValue:
    ...
    def test_information_value_to_dict(self):
        ...
        value = InformationValue(
            value=0.75, confidence=0.3, representation=0.1, domain_novelty=0.9
        )
    ...
    def test_information_value_reason_generation(self):
        ...
        assert value.reason
        assert (
            "incerteza" in value.reason.lower() or "uncertainty" in value.reason.lower()
        )
