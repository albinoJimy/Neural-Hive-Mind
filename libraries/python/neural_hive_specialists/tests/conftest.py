...
_compliance_mongo_patch = patch(
    "neural_hive_specialists.compliance.audit_logger.MongoClient", return_value=MockMongoClient()
)
...
_query_api_mongo_patch = patch(
    "neural_hive_specialists.ledger.query_api.MongoClient", return_value=MockMongoClient()
)
...
def mock_specialist(mocker, mock_config):
    ...
    # Mock health_check
    specialist.health_check = mocker.MagicMock(return_value={"status": "SERVING", "details": {}})
