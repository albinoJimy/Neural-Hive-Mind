...
class TestAuthInterceptor:
    ...
    def test_check_permissions_valid(self, auth_interceptor):
        ...
        payload = {"sub": "consensus-engine", "service_type": "consensus-engine"}
        ...
        assert (
            auth_interceptor._check_permissions(
                payload, "/neural_hive.specialist.SpecialistService/EvaluatePlan"
            )
            is True
        )
        assert (
            auth_interceptor._check_permissions(
                payload, "/neural_hive.specialist.SpecialistService/GetCapabilities"
            )
            is True
        )
    ...
    def test_check_permissions_invalid_service_type(self, auth_interceptor):
        ...
        payload = {"sub": "unknown-service", "service_type": "unknown"}
