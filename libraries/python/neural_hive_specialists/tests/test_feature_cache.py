...
class TestFeatureCache:
    ...
    def test_cache_init_success(self, mock_redis):
        ...
        cache = FeatureCache(
            redis_cluster_nodes="localhost:6379", specialist_type="business"
        )
    ...
    def test_cache_set_serialization_error(self, feature_cache, mock_redis):
        ...
        features = {"aggregated_features": {"feature1": 0.5}}
...
class TestFeatureCacheIntegration:
    ...
    def test_real_redis_connection(self):
        ...
        cache = FeatureCache(
            redis_cluster_nodes="localhost:6379", specialist_type="test"
        )
