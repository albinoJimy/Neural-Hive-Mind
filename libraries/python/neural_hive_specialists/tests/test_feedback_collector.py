...
class TestFeedbackCollector:
    ...
    def test_submit_feedback_invalid_rating(self, feedback_collector, sample_feedback_data, mock_config):
    ...
    def test_submit_feedback_audits_submission(self, feedback_collector, sample_feedback_data, mock_audit_logger):
    ...
    def test_circuit_breaker_usage_on_insert(self, feedback_collector, sample_feedback_data):
