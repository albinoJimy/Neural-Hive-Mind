...
def sample_explainability_data():
    ...
    return {
        ...
        "prediction": {"confidence_score": 0.85, "risk_score": 0.25},
...
class TestExplainabilityLedgerV2Persistence:
    ...
    def test_persist_generates_unique_tokens(self, ledger, sample_explainability_data):
        ...
        token1 = ledger.persist(sample_explainability_data, specialist_type="technical")

        # Modificar dados
        modified_data = sample_explainability_data.copy()
        modified_data["plan_id"] = "plan-456"

        token2 = ledger.persist(modified_data, specialist_type="technical")
    ...
    def test_retrieve_success(self, ledger):
        ...
        # Mock find_one
        mock_collection = ledger.mongo_client[ledger.config.mongodb_database][
