...
class TestTrainOnHistoricalData:
    ...
    def test_model_persistence(self, detector, normal_metrics_history, mock_config):
        ...
        base_path = mock_config['anomaly_model_path'].format(specialist_type='technical').replace('.pkl', '')
...
class TestDetectAnomalies:
    ...
    def test_identify_anomalous_features(self, detector, normal_metrics_history, anomalous_metrics):
        ...
        if result['is_anomaly']:
            ...
            assert any('consensus_agreement' in f or 'false_positive' in f or 'false_negative' in f
