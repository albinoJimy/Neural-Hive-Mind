...
class TestCreateSecureGrpcChannel:
    ...
    async def test_create_secure_channel_with_valid_x509_svid(
        ...
        with patch(
            "neural_hive_security.grpc_channel_factory.grpc.aio.secure_channel"
    ...
    @pytest.mark.asyncio
    async def test_fallback_insecure_only_in_dev_environment(self, spiffe_config_dev):
        ...
        with patch(
            "neural_hive_security.grpc_channel_factory.grpc.aio.insecure_channel"
        ) as mock_insecure:
            mock_channel = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_no_fallback_in_production_even_if_allowed(self, spiffe_config_prod):
    ...
    @pytest.mark.asyncio
    async def test_reuse_existing_spiffe_manager(self, spiffe_config_prod, mock_spiffe_manager):
