...
for r in results:
    ...
    nlp_feature_names = [
        ...
        'domain_security', 'domain_performance', 'domain_architecture',
        'domain_database', 'domain_testing', 'domain_devops',
        'has_url', 'has_path', 'has_email', 'has_file_path',
        'technical_patterns_count',
        'action_create', 'action_update', 'action_delete', 'action_read', 'action_deploy',
        'sentiment_positive', 'sentiment_negative', 'urgency_high'
    ]
