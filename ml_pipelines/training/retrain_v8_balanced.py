...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Retraining do Approval Model v8 (Active Learning)')
    parser.add_argument('--min-samples', type=int, default=10, help='Amostras mínimas (default: 10)')
    parser.add_argument('--model-type', type=str, default='random_forest',
                       choices=['random_forest', 'gradient_boosting'],
                       help='Tipo de modelo (default: random_forest)')
    parser.add_argument('--balanced-only', action='store_true', default=True,
                       help='Usar apenas balanced_dataset=True (default: True)')
    parser.add_argument('--all-data', action='store_true',
                       help='Usar todos os dados, ignorando filtro balanced')
