...
def main():
    ...
    with mlflow.start_run() as run:
        ...
        mlflow.log_metrics({
            ...
            "train_precision": precision_score(y_train, model.predict(X_train), average='weighted', zero_division=0),
            "train_recall": recall_score(y_train, model.predict(X_train), average='weighted', zero_division=0)
        })
