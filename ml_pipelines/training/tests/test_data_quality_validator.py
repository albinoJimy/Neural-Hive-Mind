...
class TestDataQualityValidator:
    ...
    def test_validate_and_raise_success(self, validator, perfect_data, feature_names):
        ...
        result = validator.validate_and_raise(perfect_data, feature_names, min_quality_score=0.6)
    ...
    def test_validate_and_raise_failure(self, validator):
        ...
        with pytest.raises(DataQualityError) as exc_info:
            validator.validate_and_raise(df, expected_features, min_quality_score=0.8)
    ...
    def test_quality_score_calculation(self, validator, feature_names):
        ...
        df_schema = pd.DataFrame({"feature_a": data["feature_a"], "label": data["label"]})
    ...
    def test_configuration_from_params(self):
        ...
        validator = DataQualityValidator(
            max_missing_pct=10.0, min_class_pct=10.0, max_correlation=0.99
        )
