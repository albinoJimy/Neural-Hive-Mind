...
def train_and_save_model(df, version: str):
    ...
    model = RandomForestClassifier(
        n_estimators=100, max_depth=10, random_state=42, class_weight="balanced", min_samples_leaf=2
    )
...
def main():
    ...
    parser.add_argument(
        "--version", type=str, default=None, help="Versão do modelo (auto se não especificado)"
    )
