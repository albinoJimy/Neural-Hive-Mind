...
def main():
    ...
    parser = argparse.ArgumentParser(description="Treinar modelo ML para Business Specialist")
    parser.add_argument(
    ...
    with mlflow.start_run() if args.mlflow_enabled else nullcontext():
        ...
        if args.mlflow_enabled:
            ...
            mlflow.sklearn.log_model(
                model, "business_specialist_model", registered_model_name=args.model_name
            )
