...
(
    ...
    latency_ms UInt32 COMMENT 'Latência total em milissegundos (alias para queries)',
    status String COMMENT 'Status final (success, error, timeout)',
    worker_id String COMMENT 'ID do worker que executou',
    service String COMMENT 'Nome do serviço que processou o ticket',
    sla_threshold_ms UInt32 COMMENT 'Threshold de SLA em milissegundos para o ticket',
