...
class TestAnthropicProvider:
    ...
    async def test_extract_text_simple_response(self, anthropic_provider) -> None:
    ...
    async def test_extract_text_multiple_blocks(self, anthropic_provider) -> None:
    ...
    def test_calculate_cost_opus(self, anthropic_provider) -> None:
        ...
        cost = anthropic_provider._calculate_cost(input_tokens=1000, output_tokens=500)
    ...
    async def test_generate_with_mock(self, anthropic_provider, mock_anthropic_client) -> None:
    ...
    def test_repr(self, anthropic_provider) -> None:
        ...
        assert repr(anthropic_provider) == "AnthropicProvider(model=claude-3-sonnet-20240229)"
