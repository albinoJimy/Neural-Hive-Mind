#!/usr/bin/env bash
# =============================================================================
# DEPRECATED: Use './scripts/security.sh policies transition' instead
# =============================================================================
...
echo "Use: ./scripts/security.sh policies transition" >&2
echo "Redirecionando para o novo CLI..." >&2
echo "============================================================" >&2

exec "${SCRIPT_DIR}/security.sh" policies transition "$@"
