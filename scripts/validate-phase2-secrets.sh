#!/usr/bin/env bash
# =============================================================================
# DEPRECATED: Use './scripts/security.sh secrets validate --phase 2' instead
# =============================================================================
...
echo "Use: ./scripts/security.sh secrets validate --phase 2" >&2
echo "Redirecionando para o novo CLI..." >&2
echo "============================================================" >&2

exec "${SCRIPT_DIR}/security.sh" secrets validate --phase 2 "$@"
